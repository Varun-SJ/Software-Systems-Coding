...
public class ClientHandler extends Thread {
	...
	private void listRecipes(Writer out) throws IOException {
		File[] files = new File(
				"D:\\$SSHOME\\Eclipse Workspace\\Software_Systems\\src\\ss\\week7\\recipeserver\\recipes").listFiles();
		for (File file : files) {
	...
	private void showRecipe(String recipeName, Writer out) throws IOException {
		String recipeFilename = "D:\\$SSHOME\\Eclipse Workspace\\Software_Systems\\src\\ss\\week7\\recipeserver\\recipes"
				+ File.separator + recipeName;
